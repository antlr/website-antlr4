...
document.write("<ul>");
document.write("<li><a href='https://theantlrguy.atlassian.net/wiki/display/ANTLR4/Getting+Started+with+ANTLR+v4'>Getting Started</a></li>");
document.write("<li><a href='http://pragprog.com/book/tpantlr2/the-definitive-antlr-4-reference'>ANTLR v4 Book</a></li>");
document.write("<li><a href='https://theantlrguy.atlassian.net/wiki/display/ANTLR4/ANTLR+4+Documentation'>Documentation</a></li>");
...
document.write("<li><a href='https://theantlrguy.atlassian.net/wiki/display/ANTLR4/ANTLR+v4+FAQ'>FAQ</a></li>");
...
paypal = "<br><center><form action='https://www.paypal.com/cgi-bin/webscr' method='post'>"+
